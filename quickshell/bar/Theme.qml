...
Item {
    ...
    property string launcherLogoText: "cachyos"  // "cachyos", "omarchy", "hyprland", "arch", or "omacom"
    property string launcherLogoIcon: "arch"  // see launcherLogoIconGlyph()
    ...
    readonly property var launcherLogoTextOptions: ["cachyos", "omarchy", "hyprland", "arch", "omacom"]
